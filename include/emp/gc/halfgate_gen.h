...
#include "emp/io/io_channel.h"
#include "emp/io/net_io_channel.h"
#include "emp/io/file_io_channel.h"
#include "block.h"
#include "emp/utils/utils.h"
#include "emp/utils/prp.h"
#include "emp/utils/hash.h"
#include "emp/garble/garble_gate_halfgates.h"
...
class HalfGateGen:public GarbleCircuit{ public:
	...
	block gen_and(const block& a, const block& b) {
		...
		if (isZero(&a) or isZero(&b)) {
			...
			garble_gate_garble_halfgates(GARBLE_GATE_AND, 
                                         a, xorBlocks(a,delta), 
                                         b, xorBlocks(b,delta), 
                                         &out[0], &out[1], 
                                         delta, table, 
